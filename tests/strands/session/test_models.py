...
class TestSessionWithState:
    ...
    def test_session_creation_with_initial_state(self):
        ...
        initial_state = {"default": {"key": "value"}, "custom": {"setting": "enabled"}}

        session = Session(session_id="test_session", user_id="user123", agent_id="agent456", state=initial_state)
    ...
    def test_session_to_dict_includes_state(self):
        ...
        session = Session.create_new("user123", "agent456")
        session.state = {"default": {"tool_count": 5}, "sdk": {"conversation_type": "sliding"}}
    ...
    def test_session_from_dict_with_state(self):
        ...
        session_data = {
            ...
            "agent_id": "agent456",
            "messages": [],
            "state": {"default": {"key": "value"}, "custom": {"setting": True}},
    ...
    def test_session_serialization_roundtrip_with_state(self):
        ...
        original_session.state = {
            "default": {"tool_executions": 10, "api_key": "secret123"},
            "user_settings": {"theme": "dark", "notifications": True},
            "sdk": {"conversation_manager": "SlidingWindow", "last_summary": "User discussed project requirements"},
        }
    ...
    def test_session_state_with_complex_data(self):
        ...
        complex_state = {
            "default": {
                "counters": {"tool_calls": 15, "errors": 2, "retries": 1},
                "configuration": {
                    "max_tokens": 1000,
                    "temperature": 0.7,
                    "model_settings": {"streaming": True, "timeout": 30},
                },
            },
            "user_profile": {
                "preferences": {"language": "en", "timezone": "UTC", "features": ["advanced_mode", "debug_logs"]}
            },
            "sdk": {"conversation_metadata": {"total_messages": 25, "last_summary_at": 20, "summary_count": 2}},
        }
    ...
    def test_session_state_empty_namespaces(self):
        ...
        session = Session.create_new("user123", "agent456")
        session.state = {"default": {}, "empty_namespace": {}, "populated": {"key": "value"}}
...
class TestSessionBackwardCompatibility:
    ...
    def test_mixed_session_data_formats(self):
        ...
        # Old format session
        old_session = Session.from_dict({"session_id": "old", "user_id": "user1", "agent_id": "agent1", "messages": []})
...
class TestSessionStateEdgeCases:
    ...
    def test_session_with_none_state(self):
        ...
        session = Session(session_id="test", user_id="user", agent_id="agent", state=None)
